...
<div class="az-content-body pd-lg-l-40 d-flex flex-column">
  ...
  <form action="{{url('/user/transaksi/filter')}}" method="post">
    @csrf
    <div class="row">
      <div class="col-4"><input type="date" value="{{$startdate}}" name="tanggalmulai"class="form-control"></div>
      <div class="col-4"><input type="date" value="{{$enddate}}"name="tanggalakhir"class="form-control"></div>
